...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Bloom_OnEnable_m266500328250E28A250719918C2C5042C7B802BB (Bloom_t26A89084F1DE8B6A96DDD69D8166A8E844EE673C * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		L_2 = Shader_Find_m596EC6EBDCA8C9D5D86E2410A319928C1E8E6B5A(_stringLiteral30245BC99B9312D571EE0A8F1703B93F992F1F66, /*hidden argument*/NULL);
		G_B3_0 = L_2;
		goto IL_0020;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Bloom_OnRenderImage_m073FCD8423DB513F3C856C4E030BE793F5603BF4 (Bloom_t26A89084F1DE8B6A96DDD69D8166A8E844EE673C * __this, RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * ___source0, RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * ___destination1, const RuntimeMethod* method)
{
	...
	int32_t V_12 = 0;
	RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * V_13 = NULL;
	bool V_14 = false;
	int32_t V_15 = 0;
	bool V_16 = false;
	int32_t V_17 = 0;
	RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * V_18 = NULL;
	bool V_19 = false;
	int32_t V_20 = 0;
	bool V_21 = false;
	bool V_22 = false;
	...
	}
	{
		...
		// th /= 2;
		int32_t L_8 = V_2;
		V_2 = ((int32_t)((int32_t)L_8/(int32_t)2));
	}
...
IL_0036:
	{
		...
		float L_12 = __this->get__radius_6();
		V_4 = ((float)il2cpp_codegen_subtract((float)((float)il2cpp_codegen_add((float)L_11, (float)L_12)), (float)(8.0f)));
		// var logh_i = (int)logh;
		float L_13 = V_4;
		...
		int32_t L_14 = V_5;
		int32_t L_15;
		L_15 = Mathf_Clamp_mAD0781EB7470594CD4482DD64A0D739E4E539C3C(L_14, 1, ((int32_t)16), /*hidden argument*/NULL);
		V_6 = L_15;
		// var lthresh = thresholdLinear;
		float L_16;
		L_16 = Bloom_get_thresholdLinear_m0B4B57713DA7522431A1D74D13320870AE7731A0(__this, /*hidden argument*/NULL);
		V_7 = L_16;
		// _material.SetFloat("_Threshold", lthresh);
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_17 = __this->get__material_11();
		float L_18 = V_7;
		Material_SetFloat_mBE01E05D49E5C7045E010F49A38E96B101D82768(L_17, _stringLiteral207B3D9446F2D4167D3D15FA99BDA04AA93AD0A0, L_18, /*hidden argument*/NULL);
		// var knee = lthresh * _softKnee + 1e-5f;
		float L_19 = V_7;
		float L_20 = __this->get__softKnee_5();
		V_8 = ((float)il2cpp_codegen_add((float)((float)il2cpp_codegen_multiply((float)L_19, (float)L_20)), (float)(9.99999975E-06f)));
		// var curve = new Vector3(lthresh - knee, knee * 2, 0.25f / knee);
		float L_21 = V_7;
		float L_22 = V_8;
		float L_23 = V_8;
		float L_24 = V_8;
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E *)(&V_9), ((float)il2cpp_codegen_subtract((float)L_21, (float)L_22)), ((float)il2cpp_codegen_multiply((float)L_23, (float)(2.0f))), ((float)((float)(0.25f)/(float)L_24)), /*hidden argument*/NULL);
		// _material.SetVector("_Curve", curve);
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_25 = __this->get__material_11();
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_26 = V_9;
		Vector4_tA56A37FC5661BCC89C3DDC24BE12BA5BCB6A02C7  L_27;
		L_27 = Vector4_op_Implicit_mDCFA56E9D34979E1E2BFE6C2D61F1768D934A8EB(L_26, /*hidden argument*/NULL);
		Material_SetVector_mCB22CD5FDA6D8C7C282D7998A9244E12CC293F0D(L_25, _stringLiteral87C43E0C533B5BE7D4EAEA9F762B4B033313B85F, L_27, /*hidden argument*/NULL);
		// var pfo = !_highQuality && _antiFlicker;
		bool L_28 = __this->get__highQuality_8();
		if (L_28)
		{
			goto IL_00d3;
		}
	...
	{
		bool L_29 = __this->get__antiFlicker_9();
		G_B8_0 = ((int32_t)(L_29));
		goto IL_00d4;
	}
...
IL_00f1:
	{
		...
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_32 = __this->get__material_11();
		float L_33 = V_4;
		int32_t L_34 = V_5;
		Material_SetFloat_mBE01E05D49E5C7045E010F49A38E96B101D82768(L_32, _stringLiteral3CB951C5C06E2A9CE696B22F5090A82016181ECD, ((float)il2cpp_codegen_subtract((float)((float)il2cpp_codegen_add((float)(0.5f), (float)L_33)), (float)((float)((float)L_34)))), /*hidden argument*/NULL);
		// _material.SetFloat("_Intensity", intensity);
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_35 = __this->get__material_11();
		float L_36;
		L_36 = Bloom_get_intensity_mE9F68DA2CEAB373F2F3563591E6001501888B138(__this, /*hidden argument*/NULL);
		Material_SetFloat_mBE01E05D49E5C7045E010F49A38E96B101D82768(L_35, _stringLiteral4E207A1E776F6188653FF9228A95BFD3A17B492E, L_36, /*hidden argument*/NULL);
		// var prefiltered = RenderTexture.GetTemporary(tw, th, 0, rtFormat);
		int32_t L_37 = V_1;
		int32_t L_38 = V_2;
		int32_t L_39 = V_3;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_40;
		L_40 = RenderTexture_GetTemporary_mEA38E780ED9C1E065B97E85BBC63F8DE548C7B8E(L_37, L_38, 0, L_39, /*hidden argument*/NULL);
		V_11 = L_40;
		// var pass = _antiFlicker ? 1 : 0;
		bool L_41 = __this->get__antiFlicker_9();
		if (L_41)
		{
			goto IL_0141;
		}
...
IL_0142:
	{
		...
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_43 = V_11;
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_44 = __this->get__material_11();
		int32_t L_45 = V_12;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_42, L_43, L_44, L_45, /*hidden argument*/NULL);
		// var last = prefiltered;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_46 = V_11;
		V_13 = L_46;
...
IL_015e:
	{
		...
		// );
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_47 = __this->get__blurBuffer1_13();
		int32_t L_48 = V_15;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_49 = V_13;
		int32_t L_50;
		L_50 = VirtFuncInvoker0< int32_t >::Invoke(4 /* System.Int32 UnityEngine.Texture::get_width() */, L_49);
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_51 = V_13;
		int32_t L_52;
		L_52 = VirtFuncInvoker0< int32_t >::Invoke(6 /* System.Int32 UnityEngine.Texture::get_height() */, L_51);
		int32_t L_53 = V_3;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_54;
		L_54 = RenderTexture_GetTemporary_mEA38E780ED9C1E065B97E85BBC63F8DE548C7B8E(((int32_t)((int32_t)L_50/(int32_t)2)), ((int32_t)((int32_t)L_52/(int32_t)2)), 0, L_53, /*hidden argument*/NULL);
		ArrayElementTypeCheck (L_47, L_54);
		(L_47)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_48), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)L_54);
...
IL_0188:
	{
		bool L_56 = __this->get__antiFlicker_9();
		if (L_56)
		{
			goto IL_0193;
		}
...
IL_0194:
	{
		...
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_57 = V_13;
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_58 = __this->get__blurBuffer1_13();
		int32_t L_59 = V_15;
		int32_t L_60 = L_59;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_61 = (L_58)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_60));
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_62 = __this->get__material_11();
		int32_t L_63 = V_12;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_57, L_61, L_62, L_63, /*hidden argument*/NULL);
		// last = _blurBuffer1[level];
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_64 = __this->get__blurBuffer1_13();
		int32_t L_65 = V_15;
		int32_t L_66 = L_65;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_67 = (L_64)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_66));
		V_13 = L_67;
		// for (var level = 0; level < iterations; level++)
		int32_t L_68 = V_15;
		V_15 = ((int32_t)il2cpp_codegen_add((int32_t)L_68, (int32_t)1));
	}
...
IL_01c1:
	...
	}
	{
		...
		int32_t L_72 = V_6;
		V_17 = ((int32_t)il2cpp_codegen_subtract((int32_t)L_72, (int32_t)2));
		goto IL_024b;
	}
...
IL_01d5:
	{
		...
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_73 = __this->get__blurBuffer1_13();
		int32_t L_74 = V_17;
		int32_t L_75 = L_74;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_76 = (L_73)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_75));
		V_18 = L_76;
		// _material.SetTexture("_BaseTex", basetex);
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_77 = __this->get__material_11();
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_78 = V_18;
		Material_SetTexture_m04A1CD55201841F85E475992931A210229C782CF(L_77, _stringLiteralD62D0620DCC59E7C5F2161A049F9FF6D888D2E74, L_78, /*hidden argument*/NULL);
		// _blurBuffer2[level] = RenderTexture.GetTemporary(
		//     basetex.width, basetex.height, 0, rtFormat
		// );
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_79 = __this->get__blurBuffer2_14();
		int32_t L_80 = V_17;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_81 = V_18;
		int32_t L_82;
		L_82 = VirtFuncInvoker0< int32_t >::Invoke(4 /* System.Int32 UnityEngine.Texture::get_width() */, L_81);
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_83 = V_18;
		int32_t L_84;
		...
		L_86 = RenderTexture_GetTemporary_mEA38E780ED9C1E065B97E85BBC63F8DE548C7B8E(L_82, L_84, 0, L_85, /*hidden argument*/NULL);
		ArrayElementTypeCheck (L_79, L_86);
		(L_79)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_80), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)L_86);
		// pass = _highQuality ? 6 : 5;
		bool L_87 = __this->get__highQuality_8();
		if (L_87)
		{
			goto IL_021d;
		}
...
IL_021e:
	{
		...
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_88 = V_13;
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_89 = __this->get__blurBuffer2_14();
		int32_t L_90 = V_17;
		int32_t L_91 = L_90;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_92 = (L_89)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_91));
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_93 = __this->get__material_11();
		int32_t L_94 = V_12;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_88, L_92, L_93, L_94, /*hidden argument*/NULL);
		// last = _blurBuffer2[level];
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_95 = __this->get__blurBuffer2_14();
		int32_t L_96 = V_17;
		int32_t L_97 = L_96;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_98 = (L_95)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_97));
		V_13 = L_98;
		// for (var level = iterations - 2; level >= 0; level--)
		int32_t L_99 = V_17;
		V_17 = ((int32_t)il2cpp_codegen_subtract((int32_t)L_99, (int32_t)1));
	}
...
IL_024b:
	...
	}
	{
		...
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_102 = __this->get__material_11();
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_103 = ___source0;
		Material_SetTexture_m04A1CD55201841F85E475992931A210229C782CF(L_102, _stringLiteralD62D0620DCC59E7C5F2161A049F9FF6D888D2E74, L_103, /*hidden argument*/NULL);
		// pass = _highQuality ? 8 : 7;
		bool L_104 = __this->get__highQuality_8();
		if (L_104)
		{
			goto IL_0279;
		}
...
IL_027a:
	{
		...
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_105 = V_13;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_106 = ___destination1;
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_107 = __this->get__material_11();
		int32_t L_108 = V_12;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_105, L_106, L_107, L_108, /*hidden argument*/NULL);
...
IL_0292:
	{
		...
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_109 = __this->get__blurBuffer1_13();
		int32_t L_110 = V_20;
		int32_t L_111 = L_110;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_112 = (L_109)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_111));
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_113;
		L_113 = Object_op_Inequality_mE1F187520BD83FB7D86A6D850710C4D42B864E90(L_112, (Object_tF2F3778131EFF286AF62B7B013A170F95A91571A *)NULL, /*hidden argument*/NULL);
		V_21 = L_113;
		bool L_114 = V_21;
		if (!L_114)
		{
	...
	}
	{
		...
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_115 = __this->get__blurBuffer1_13();
		int32_t L_116 = V_20;
		int32_t L_117 = L_116;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_118 = (L_115)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_117));
		RenderTexture_ReleaseTemporary_m2BF2BDDC359A491C05C401B977878DAE1D0850D4(L_118, /*hidden argument*/NULL);
	}
...
IL_02b7:
	{
		...
		int32_t L_120 = V_20;
		int32_t L_121 = L_120;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_122 = (L_119)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_121));
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_123;
		L_123 = Object_op_Inequality_mE1F187520BD83FB7D86A6D850710C4D42B864E90(L_122, (Object_tF2F3778131EFF286AF62B7B013A170F95A91571A *)NULL, /*hidden argument*/NULL);
		V_22 = L_123;
		bool L_124 = V_22;
		if (!L_124)
		{
	...
	}
	{
		...
		int32_t L_126 = V_20;
		int32_t L_127 = L_126;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_128 = (L_125)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_127));
		RenderTexture_ReleaseTemporary_m2BF2BDDC359A491C05C401B977878DAE1D0850D4(L_128, /*hidden argument*/NULL);
	}

IL_02db:
	{
		// _blurBuffer1[i] = null;
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_129 = __this->get__blurBuffer1_13();
		int32_t L_130 = V_20;
		ArrayElementTypeCheck (L_129, NULL);
		(L_129)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_130), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)NULL);
		// _blurBuffer2[i] = null;
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_131 = __this->get__blurBuffer2_14();
		int32_t L_132 = V_20;
		ArrayElementTypeCheck (L_131, NULL);
		(L_131)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_132), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)NULL);
		// for (var i = 0; i < kMaxIterations; i++)
		int32_t L_133 = V_20;
		V_20 = ((int32_t)il2cpp_codegen_add((int32_t)L_133, (int32_t)1));
	}
...
IL_02f6:
	...
	}
	{
		...
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_136 = V_11;
		RenderTexture_ReleaseTemporary_m2BF2BDDC359A491C05C401B977878DAE1D0850D4(L_136, /*hidden argument*/NULL);
		// }
		return;
	}
}
